        ...
        <div class="col-md-12 border pt-3 pb-3" style="padding-right: 5px; padding-left: 15px;">
            <div class="box box-primary box-solid">
                <div class="box-header">
                    <h2 class="box-title">Input Data Poli</h2>
                </div>
                <div class="box-body">
					...
					<button class="btn btn-block btn-info p-5" onclick="lihatRo()">Lihat Riwayat Rontgn</button>
                    <hr class="garisBawah">
...
<script>
  // Fungsi untuk membuka halaman upload dengan parameter norm
                function lihatRo() {
                    ...
                    var uploadURL = "http://172.16.10.88/RO/lihat_foto.php?norm=" + encodeURIComponent(normValue);

                    window.open(uploadURL, "_blank");
                }  
</script>
<script src="<?php echo base_url('asset/js/custom/daftarTungguPoli.js'); ?>"></script>
<script src="<?php echo base_url('asset/js/custom/inputPoli.js'); ?>"></script>
<script src="<?php echo base_url('asset/js/custom/audio.js'); ?>"></script>
